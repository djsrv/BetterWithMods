...
public class HCBuckets extends Feature {
    ...
    private boolean hardcoreLavaBuckets;
    private boolean moddedContainers;

    @Override
    public void setupConfig() {
        hardcoreLavaBuckets = loadPropBool("Hardcore Lava Buckets", "Makes lava buckets hot if you don't have a fire resistance potion", true);
        moddedContainers = loadPropBool("Modded Containers", "Hardcore Buckets Affects Modded Fluid Containers", true);
    }
    ...
    private static void editModdedFluidDispenseBehavior() {
