...
import betterwithmods.modules.core.client.render.RenderCowHarness;
import betterwithmods.modules.core.client.render.RenderPigHarness;
import betterwithmods.modules.core.client.render.RenderSheepHarness;
import betterwithmods.modules.utilities.items.ItemBreedingHarness;
 ...
 * @version 11/27/16
 */
public class BreedingHardness extends Feature {
    public static Item BREEDING_HARNESS;

    @Override
    public void preInit(FMLPreInitializationEvent event) {
        BREEDING_HARNESS = new ItemBreedingHarness().setRegistryName("breeding_harness");
    ...
    public void preInitClient(FMLPreInitializationEvent event) {
        ...
        ModelHandler.setInventoryModel(BREEDING_HARNESS);
    ...
    private static boolean isValidAnimal(Entity animal) {
