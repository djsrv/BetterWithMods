...
public class BlockBUD extends BWMBlock {
    ...
    private static final Set<Block> BLACKLIST = Sets.newHashSet(Redstone.BUDDY_BLOCK, Blocks.REDSTONE_WIRE, Blocks.POWERED_REPEATER, Blocks.UNPOWERED_REPEATER, Blocks.REDSTONE_TORCH, Blocks.UNLIT_REDSTONE_TORCH, Redstone.LIGHT);
