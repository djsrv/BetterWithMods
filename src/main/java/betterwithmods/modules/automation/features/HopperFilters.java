...
import betterwithmods.base.blocks.BlockBWMPane;
import betterwithmods.base.blocks.BlockRope;
...
public class HopperFilters extends Feature {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        HopperFilters.addFilter(5, BWMBlocks.PANE, BlockBWMPane.EnumPaneType.WICKER.getMeta(), HopperFilters::isParticulate);
