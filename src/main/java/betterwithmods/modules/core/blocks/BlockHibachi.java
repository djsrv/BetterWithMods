...
public class BlockHibachi extends BWMBlock {
    ...
    public void updateTick(World world, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (powered) {
            if (!isLit(world, pos))
                ...
                if (above != Blocks.FIRE && above != Stoking.STOKED_FLAME) {
    ...
    public boolean isCurrentlyValid(World world, BlockPos pos) {
        ...
        if (isLit(world, pos)) {
            ...
            if (block != Blocks.FIRE && block != Stoking.STOKED_FLAME) {
                if (shouldIgnite(world, pos.up()))
                    return false;
            }
        }
    ...
    private void extinguish(World world, BlockPos pos) {
        ...
        boolean isFire = world.getBlockState(pos.up()).getBlock() == Blocks.FIRE || world.getBlockState(pos.up()).getBlock() == Stoking.STOKED_FLAME;
