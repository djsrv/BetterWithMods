...
public class ContainerFilteredHopper extends Container {
    ...
    public boolean isItemFilter(ItemStack stack) {
        if (stack.getItem() instanceof ItemBlock) {
            ...
            if (block instanceof BlockLadder || block instanceof BlockTrapDoor || stack.getItem() == Item.getItemFromBlock(Blocks.SOUL_SAND) || stack.getItem() == Item.getItemFromBlock(Blocks.IRON_BARS) || block instanceof BWMBlockPane)
                return true;
        }
        return false;
    }
